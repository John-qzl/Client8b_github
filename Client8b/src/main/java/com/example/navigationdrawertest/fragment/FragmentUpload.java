...
public class FragmentUpload extends Fragment{
	...
	public FragmentUpload(RwRelation proEntity,String fieldType, BCRelation BCproEntity){
...
//		}
	...
	private void loadData() {
		...
		List<Task> taskList_rw = DataSupport.where("location = ? and xhId =?  and fieldType=?", "4", xhId, fieldType).find(Task.class);
