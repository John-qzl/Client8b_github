...
//                    post(this::showDropDown);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        arrowDrawableResId = typedArray.getResourceId(R.styleable.NiceSpinner_arrowDrawable, R.drawable.arrowselect);
    ...
    public void setArrowDrawable(@DrawableRes @ColorRes int drawableId) {
        ...
        arrowDrawable = initArrowDrawable(R.drawable.arrowselect);
        setArrowDrawableOrHide(arrowDrawable);
    }
